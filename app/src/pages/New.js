...
import { KeyboardAvoidingView, ScrollView, StyleSheet, Text, Image, TouchableOpacity, TextInput } from 'react-native';
...
export default class New extends Component {
  static navigationOptions = ({ navigation }) => ({
    headerRight: (
      <TouchableOpacity onPress={() => navigation.navigate('Feed')}>
        <Text style={{ marginHorizontal: 20 }}>Voltar</Text>
      </TouchableOpacity>
    ),
  ...
  handleSelectImage = () => {
    ImagePicker.showImagePicker({
      ...
      const { error, didCancel, data, fileName, uri, type } = upload
